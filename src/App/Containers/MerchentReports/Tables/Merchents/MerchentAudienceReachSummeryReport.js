...
const MerchentsAudienceReachSummeryReport = (props) => {
                    ...
                    <div className="border border-teal-500 shadow-lg modal-container bg-white w-11/12 md:max-w-md mx-auto rounded shadow-lg z-50 overflow-y-auto">
                        <div className="modal-content py-4 text-left px-6">
                            <div className="flex justify-between items-center pb-3">
                                <p className="text-2xl font-bold">{t("reports.modal22Title")}</p>
    ...
    return(
        <div>
            ...
            { renderHeader()}
            { renderModal()}
            { props.audienceReachSummeryReportForMerchentsMV?.views?.map((item, key)=>renderMerchent(item, key)) }
           {props.audienceReachSummeryReportForMerchentsMV?.totalItems>paginationAndFilterData.size && (
            <Pagination
                currentPage={props.audienceReachSummeryReportForMerchentsMV?.page}
                totalPages={props.audienceReachSummeryReportForMerchentsMV?.totalPages}
