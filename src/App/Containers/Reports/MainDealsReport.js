...
import DealsChart from "../../Containers/Reports/Charts/DealsReport";
import DealsTable from "../../Containers/Reports/Tables/Deals/DealsAudienceReachSummeryReport";
            ...
            <Card type="primary" size="full" className="  mb-2">
                <div className="flex justify-between">
                    <div className="flex justify-start">
                        <Typography color="primary" type="h1">Audience Reach Report for Deals</Typography>
                    </div>             
                </div>
            </Card>
        )
